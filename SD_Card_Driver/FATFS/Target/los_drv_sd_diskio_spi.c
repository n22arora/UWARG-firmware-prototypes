 ...
 ******************************************************************************
  ...
  * @brief   This file contains the implementation of the los_drv_sd_diskio_spi
  *          FatFs driver.
  ******************************************************************************
...
#include "los_drv_sd_diskio_spi.h"

//Make sure you set #define LOS_DRV_SD_SPI_HANDLE as some hspix in main.h
...
extern SPI_HandleTypeDef LOS_DRV_SD_SPI_HANDLE;

/* Function prototypes */

//(Note that the _256 is used as a mask to clear the prescalar bits as it provides binary 111 in the correct position)
#define FCLK_SLOW() { MODIFY_REG(LOS_DRV_SD_SPI_HANDLE.Instance->CR1, SPI_BAUDRATEPRESCALER_256, SPI_BAUDRATEPRESCALER_128); }	/* Set SCLK = slow, approx 280 KBits/s*/
#define FCLK_FAST() { MODIFY_REG(LOS_DRV_SD_SPI_HANDLE.Instance->CR1, SPI_BAUDRATEPRESCALER_256, SPI_BAUDRATEPRESCALER_8); }	/* Set SCLK = fast, approx 4.5 MBits/s */
...
inline DRESULT LOS_DRV_SD_SPI_read (
	BYTE drv,		/* Physical drive number (0) */
...
#if _USE_WRITE
inline DRESULT LOS_DRV_SD_SPI_write (
	BYTE drv,			/* Physical drive number (0) */
